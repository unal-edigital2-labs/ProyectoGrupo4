...
module top (
	...
	input  wire LIR0,
	input  wire RIR0,
	output wire RGB_sensor_S0,
	output wire RGB_sensor_S1,
	output wire RGB_sensor_S2,
	output wire RGB_sensor_S3,
	output wire RGB_sensor_EN0,
	input  wire RGB_sensor_Out0,
	output wire motorEN10,
	output wire motorEN20,
	output wire motorEN30,
	output wire motorEN40,
	output wire stepper0,
	output wire stepper1,
	output wire stepper2,
	output wire stepper3,
	input  wire ESP82660,
	input  wire ESP82661,
	input  wire ESP82662,
	input  wire ESP82663,
...
wire RIR_we;
reg  RIR_re = 1'd0;
reg  [3:0] RGB_sensor_S_storage = 4'd0;
reg  RGB_sensor_S_re = 1'd0;
reg  RGB_sensor_EN_storage = 1'd0;
reg  RGB_sensor_EN_re = 1'd0;
wire RGB_sensor_Out_status;
wire RGB_sensor_Out_we;
reg  RGB_sensor_Out_re = 1'd0;
reg  motorEN1_storage = 1'd0;
reg  motorEN1_re = 1'd0;
reg  motorEN2_storage = 1'd0;
reg  motorEN2_re = 1'd0;
reg  motorEN3_storage = 1'd0;
reg  motorEN3_re = 1'd0;
reg  motorEN4_storage = 1'd0;
reg  motorEN4_re = 1'd0;
reg  [3:0] stepper_storage = 4'd0;
reg  stepper_re = 1'd0;
wire [5:0] ESP8266_status;
wire ESP8266_we;
reg  ESP8266_re = 1'd0;
...
wire [5:0] csrbank0_in_r;
reg  csrbank0_in_we = 1'd0;
wire [5:0] csrbank0_in_w;
wire csrbank0_sel;
...
reg  csrbank4_out0_re = 1'd0;
wire [3:0] csrbank4_out0_r;
reg  csrbank4_out0_we = 1'd0;
...
wire [2:0] csrbank6_in_r;
reg  csrbank6_in_we = 1'd0;
wire [2:0] csrbank6_in_w;
wire csrbank6_sel;
...
reg  csrbank8_r_enable0_re = 1'd0;
wire csrbank8_r_enable0_r;
reg  csrbank8_r_enable0_we = 1'd0;
wire csrbank8_r_enable0_w;
reg  csrbank8_r_width0_re = 1'd0;
wire [31:0] csrbank8_r_width0_r;
reg  csrbank8_r_width0_we = 1'd0;
wire [31:0] csrbank8_r_width0_w;
reg  csrbank8_r_period0_re = 1'd0;
wire [31:0] csrbank8_r_period0_r;
reg  csrbank8_r_period0_we = 1'd0;
wire [31:0] csrbank8_r_period0_w;
reg  csrbank8_g_enable0_re = 1'd0;
wire csrbank8_g_enable0_r;
reg  csrbank8_g_enable0_we = 1'd0;
wire csrbank8_g_enable0_w;
reg  csrbank8_g_width0_re = 1'd0;
wire [31:0] csrbank8_g_width0_r;
reg  csrbank8_g_width0_we = 1'd0;
wire [31:0] csrbank8_g_width0_w;
reg  csrbank8_g_period0_re = 1'd0;
wire [31:0] csrbank8_g_period0_r;
reg  csrbank8_g_period0_we = 1'd0;
wire [31:0] csrbank8_g_period0_w;
reg  csrbank8_b_enable0_re = 1'd0;
wire csrbank8_b_enable0_r;
reg  csrbank8_b_enable0_we = 1'd0;
wire csrbank8_b_enable0_w;
reg  csrbank8_b_width0_re = 1'd0;
wire [31:0] csrbank8_b_width0_r;
reg  csrbank8_b_width0_we = 1'd0;
wire [31:0] csrbank8_b_width0_w;
reg  csrbank8_b_period0_re = 1'd0;
wire [31:0] csrbank8_b_period0_r;
reg  csrbank8_b_period0_we = 1'd0;
wire [31:0] csrbank8_b_period0_w;
wire csrbank8_sel;
...
wire [3:0] csrbank9_out0_r;
reg  csrbank9_out0_we = 1'd0;
wire [3:0] csrbank9_out0_w;
wire csrbank9_sel;
...
reg  csrbank10_out0_re = 1'd0;
wire csrbank10_out0_r;
reg  csrbank10_out0_we = 1'd0;
wire csrbank10_out0_w;
wire csrbank10_sel;
...
reg  csrbank13_out0_re = 1'd0;
wire csrbank13_out0_r;
reg  csrbank13_out0_we = 1'd0;
wire csrbank13_out0_w;
wire csrbank13_sel;
...
reg  csrbank14_out0_re = 1'd0;
wire [3:0] csrbank14_out0_r;
reg  csrbank14_out0_we = 1'd0;
wire [3:0] csrbank14_out0_w;
wire csrbank14_sel;
...
wire [3:0] csrbank15_in_r;
reg  csrbank15_in_we = 1'd0;
wire [3:0] csrbank15_in_w;
wire csrbank15_sel;
...
reg  csrbank16_load0_re = 1'd0;
wire [31:0] csrbank16_load0_r;
reg  csrbank16_load0_we = 1'd0;
wire [31:0] csrbank16_load0_w;
reg  csrbank16_reload0_re = 1'd0;
wire [31:0] csrbank16_reload0_r;
reg  csrbank16_reload0_we = 1'd0;
wire [31:0] csrbank16_reload0_w;
reg  csrbank16_en0_re = 1'd0;
wire csrbank16_en0_r;
reg  csrbank16_en0_we = 1'd0;
wire csrbank16_en0_w;
reg  csrbank16_update_value0_re = 1'd0;
wire csrbank16_update_value0_r;
reg  csrbank16_update_value0_we = 1'd0;
wire csrbank16_update_value0_w;
reg  csrbank16_value_re = 1'd0;
wire [31:0] csrbank16_value_r;
reg  csrbank16_value_we = 1'd0;
wire [31:0] csrbank16_value_w;
...
reg  csrbank17_txfull_re = 1'd0;
wire csrbank17_txfull_r;
reg  csrbank17_txfull_we = 1'd0;
wire csrbank17_txfull_w;
reg  csrbank17_rxempty_re = 1'd0;
wire csrbank17_rxempty_r;
reg  csrbank17_rxempty_we = 1'd0;
wire csrbank17_rxempty_w;
reg  csrbank17_ev_status_re = 1'd0;
wire [1:0] csrbank17_ev_status_r;
reg  csrbank17_ev_status_we = 1'd0;
wire [1:0] csrbank17_ev_status_w;
reg  csrbank17_ev_pending_re = 1'd0;
wire [1:0] csrbank17_ev_pending_r;
reg  csrbank17_ev_pending_we = 1'd0;
wire [1:0] csrbank17_ev_pending_w;
reg  csrbank17_ev_enable0_re = 1'd0;
wire [1:0] csrbank17_ev_enable0_r;
reg  csrbank17_ev_enable0_we = 1'd0;
wire [1:0] csrbank17_ev_enable0_w;
reg  csrbank17_txempty_re = 1'd0;
wire csrbank17_txempty_r;
reg  csrbank17_txempty_we = 1'd0;
wire csrbank17_txempty_w;
reg  csrbank17_rxfull_re = 1'd0;
wire csrbank17_rxfull_r;
reg  csrbank17_rxfull_we = 1'd0;
wire csrbank17_rxfull_w;
wire csrbank17_sel;
...
assign {RGB_sensor_S3, RGB_sensor_S2, RGB_sensor_S1, RGB_sensor_S0} = RGB_sensor_S_storage;
assign {RGB_sensor_EN0} = RGB_sensor_EN_storage;
assign {motorEN10} = motorEN1_storage;
assign {motorEN20} = motorEN2_storage;
assign {motorEN30} = motorEN3_storage;
assign {motorEN40} = motorEN4_storage;
assign {stepper3, stepper2, stepper1, stepper0} = stepper_storage;
always @(*) begin
...
assign csrbank0_in_r = interface0_bank_bus_dat_w[5:0];
always @(*) begin
	csrbank0_in_we <= 1'd0;
	csrbank0_in_re <= 1'd0;
...
assign csrbank0_in_w = ESP8266_status[5:0];
assign ESP8266_we = csrbank0_in_we;
...
assign csrbank1_in_w = LIR_status;
assign LIR_we = csrbank1_in_we;
assign csrbank2_sel = (interface2_bank_bus_adr[13:9] == 3'd7);
...
assign csrbank2_out0_w = RGB_sensor_EN_storage;
...
assign csrbank3_in_w = RGB_sensor_Out_status;
assign RGB_sensor_Out_we = csrbank3_in_we;
assign csrbank4_sel = (interface4_bank_bus_adr[13:9] == 3'd6);
assign csrbank4_out0_r = interface4_bank_bus_dat_w[3:0];
always @(*) begin
	csrbank4_out0_re <= 1'd0;
	csrbank4_out0_we <= 1'd0;
	if ((csrbank4_sel & (interface4_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank4_out0_re <= interface4_bank_bus_we;
		csrbank4_out0_we <= (~interface4_bank_bus_we);
	end
end
assign csrbank4_out0_w = RGB_sensor_S_storage[3:0];
...
assign csrbank5_in_w = RIR_status;
assign RIR_we = csrbank5_in_we;
assign csrbank6_sel = (interface6_bank_bus_adr[13:9] == 2'd2);
assign csrbank6_in_r = interface6_bank_bus_dat_w[2:0];
always @(*) begin
	csrbank6_in_re <= 1'd0;
	csrbank6_in_we <= 1'd0;
...
assign csrbank6_in_w = buttons_status[2:0];
assign buttons_we = csrbank6_in_we;
assign csrbank7_sel = (interface7_bank_bus_adr[13:9] == 4'd15);
...
assign csrbank8_r_enable0_r = interface8_bank_bus_dat_w[0];
always @(*) begin
	csrbank8_r_enable0_we <= 1'd0;
	csrbank8_r_enable0_re <= 1'd0;
	if ((csrbank8_sel & (interface8_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank8_r_enable0_re <= interface8_bank_bus_we;
		csrbank8_r_enable0_we <= (~interface8_bank_bus_we);
	end
end
assign csrbank8_r_width0_r = interface8_bank_bus_dat_w[31:0];
always @(*) begin
	csrbank8_r_width0_re <= 1'd0;
	csrbank8_r_width0_we <= 1'd0;
	if ((csrbank8_sel & (interface8_bank_bus_adr[8:0] == 1'd1))) begin
		csrbank8_r_width0_re <= interface8_bank_bus_we;
		csrbank8_r_width0_we <= (~interface8_bank_bus_we);
	end
end
assign csrbank8_r_period0_r = interface8_bank_bus_dat_w[31:0];
always @(*) begin
	csrbank8_r_period0_re <= 1'd0;
	csrbank8_r_period0_we <= 1'd0;
	if ((csrbank8_sel & (interface8_bank_bus_adr[8:0] == 2'd2))) begin
		csrbank8_r_period0_re <= interface8_bank_bus_we;
		csrbank8_r_period0_we <= (~interface8_bank_bus_we);
	end
end
assign csrbank8_g_enable0_r = interface8_bank_bus_dat_w[0];
always @(*) begin
	csrbank8_g_enable0_we <= 1'd0;
	csrbank8_g_enable0_re <= 1'd0;
	if ((csrbank8_sel & (interface8_bank_bus_adr[8:0] == 2'd3))) begin
		csrbank8_g_enable0_re <= interface8_bank_bus_we;
		csrbank8_g_enable0_we <= (~interface8_bank_bus_we);
	end
end
assign csrbank8_g_width0_r = interface8_bank_bus_dat_w[31:0];
always @(*) begin
	csrbank8_g_width0_re <= 1'd0;
	csrbank8_g_width0_we <= 1'd0;
	if ((csrbank8_sel & (interface8_bank_bus_adr[8:0] == 3'd4))) begin
		csrbank8_g_width0_re <= interface8_bank_bus_we;
		csrbank8_g_width0_we <= (~interface8_bank_bus_we);
	end
end
assign csrbank8_g_period0_r = interface8_bank_bus_dat_w[31:0];
always @(*) begin
	csrbank8_g_period0_we <= 1'd0;
	csrbank8_g_period0_re <= 1'd0;
	if ((csrbank8_sel & (interface8_bank_bus_adr[8:0] == 3'd5))) begin
		csrbank8_g_period0_re <= interface8_bank_bus_we;
		csrbank8_g_period0_we <= (~interface8_bank_bus_we);
	end
end
assign csrbank8_b_enable0_r = interface8_bank_bus_dat_w[0];
always @(*) begin
	csrbank8_b_enable0_we <= 1'd0;
	csrbank8_b_enable0_re <= 1'd0;
	if ((csrbank8_sel & (interface8_bank_bus_adr[8:0] == 3'd6))) begin
		csrbank8_b_enable0_re <= interface8_bank_bus_we;
		csrbank8_b_enable0_we <= (~interface8_bank_bus_we);
	end
end
assign csrbank8_b_width0_r = interface8_bank_bus_dat_w[31:0];
always @(*) begin
	csrbank8_b_width0_re <= 1'd0;
	csrbank8_b_width0_we <= 1'd0;
	if ((csrbank8_sel & (interface8_bank_bus_adr[8:0] == 3'd7))) begin
		csrbank8_b_width0_re <= interface8_bank_bus_we;
		csrbank8_b_width0_we <= (~interface8_bank_bus_we);
	end
end
assign csrbank8_b_period0_r = interface8_bank_bus_dat_w[31:0];
always @(*) begin
	csrbank8_b_period0_we <= 1'd0;
	csrbank8_b_period0_re <= 1'd0;
	if ((csrbank8_sel & (interface8_bank_bus_adr[8:0] == 4'd8))) begin
		csrbank8_b_period0_re <= interface8_bank_bus_we;
		csrbank8_b_period0_we <= (~interface8_bank_bus_we);
	end
end
assign csrbank8_r_enable0_w = r_enable_storage;
assign csrbank8_r_width0_w = r_width_storage[31:0];
assign csrbank8_r_period0_w = r_period_storage[31:0];
assign csrbank8_g_enable0_w = g_enable_storage;
assign csrbank8_g_width0_w = g_width_storage[31:0];
assign csrbank8_g_period0_w = g_period_storage[31:0];
assign csrbank8_b_enable0_w = b_enable_storage;
assign csrbank8_b_width0_w = b_width_storage[31:0];
assign csrbank8_b_period0_w = b_period_storage[31:0];
assign csrbank9_sel = (interface9_bank_bus_adr[13:9] == 1'd0);
assign csrbank9_out0_r = interface9_bank_bus_dat_w[3:0];
always @(*) begin
...
assign csrbank9_out0_w = leds_storage[3:0];
assign csrbank10_sel = (interface10_bank_bus_adr[13:9] == 4'd9);
assign csrbank10_out0_r = interface10_bank_bus_dat_w[0];
always @(*) begin
	csrbank10_out0_we <= 1'd0;
	csrbank10_out0_re <= 1'd0;
	if ((csrbank10_sel & (interface10_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank10_out0_re <= interface10_bank_bus_we;
		csrbank10_out0_we <= (~interface10_bank_bus_we);
	end
end
assign csrbank10_out0_w = motorEN1_storage;
...
assign csrbank11_out0_w = motorEN2_storage;
assign csrbank12_sel = (interface12_bank_bus_adr[13:9] == 4'd11);
...
assign csrbank12_out0_w = motorEN3_storage;
assign csrbank13_sel = (interface13_bank_bus_adr[13:9] == 4'd12);
assign csrbank13_out0_r = interface13_bank_bus_dat_w[0];
always @(*) begin
	csrbank13_out0_re <= 1'd0;
	csrbank13_out0_we <= 1'd0;
	if ((csrbank13_sel & (interface13_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank13_out0_re <= interface13_bank_bus_we;
		csrbank13_out0_we <= (~interface13_bank_bus_we);
	end
end
assign csrbank13_out0_w = motorEN4_storage;
assign csrbank14_sel = (interface14_bank_bus_adr[13:9] == 4'd13);
assign csrbank14_out0_r = interface14_bank_bus_dat_w[3:0];
always @(*) begin
	csrbank14_out0_re <= 1'd0;
	csrbank14_out0_we <= 1'd0;
	if ((csrbank14_sel & (interface14_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank14_out0_re <= interface14_bank_bus_we;
		csrbank14_out0_we <= (~interface14_bank_bus_we);
	end
end
assign csrbank14_out0_w = stepper_storage[3:0];
assign csrbank15_sel = (interface15_bank_bus_adr[13:9] == 1'd1);
assign csrbank15_in_r = interface15_bank_bus_dat_w[3:0];
always @(*) begin
...
assign csrbank15_in_w = switchs_status[3:0];
assign switchs_we = csrbank15_in_we;
assign csrbank16_sel = (interface16_bank_bus_adr[13:9] == 5'd16);
assign csrbank16_load0_r = interface16_bank_bus_dat_w[31:0];
always @(*) begin
	csrbank16_load0_we <= 1'd0;
	csrbank16_load0_re <= 1'd0;
	if ((csrbank16_sel & (interface16_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank16_load0_re <= interface16_bank_bus_we;
		csrbank16_load0_we <= (~interface16_bank_bus_we);
	end
end
assign csrbank16_reload0_r = interface16_bank_bus_dat_w[31:0];
always @(*) begin
	csrbank16_reload0_we <= 1'd0;
	csrbank16_reload0_re <= 1'd0;
	if ((csrbank16_sel & (interface16_bank_bus_adr[8:0] == 1'd1))) begin
		csrbank16_reload0_re <= interface16_bank_bus_we;
		csrbank16_reload0_we <= (~interface16_bank_bus_we);
	end
end
assign csrbank16_en0_r = interface16_bank_bus_dat_w[0];
always @(*) begin
	csrbank16_en0_re <= 1'd0;
	csrbank16_en0_we <= 1'd0;
	if ((csrbank16_sel & (interface16_bank_bus_adr[8:0] == 2'd2))) begin
		csrbank16_en0_re <= interface16_bank_bus_we;
		csrbank16_en0_we <= (~interface16_bank_bus_we);
	end
end
assign csrbank16_update_value0_r = interface16_bank_bus_dat_w[0];
always @(*) begin
	csrbank16_update_value0_we <= 1'd0;
	csrbank16_update_value0_re <= 1'd0;
	if ((csrbank16_sel & (interface16_bank_bus_adr[8:0] == 2'd3))) begin
		csrbank16_update_value0_re <= interface16_bank_bus_we;
		csrbank16_update_value0_we <= (~interface16_bank_bus_we);
	end
end
assign csrbank16_value_r = interface16_bank_bus_dat_w[31:0];
always @(*) begin
	csrbank16_value_re <= 1'd0;
	csrbank16_value_we <= 1'd0;
	if ((csrbank16_sel & (interface16_bank_bus_adr[8:0] == 3'd4))) begin
		csrbank16_value_re <= interface16_bank_bus_we;
		csrbank16_value_we <= (~interface16_bank_bus_we);
	end
end
...
always @(*) begin
	...
	if ((csrbank16_sel & (interface16_bank_bus_adr[8:0] == 3'd6))) begin
...
always @(*) begin
	...
	if ((csrbank16_sel & (interface16_bank_bus_adr[8:0] == 3'd7))) begin
		csrbank16_ev_enable0_re <= interface16_bank_bus_we;
		csrbank16_ev_enable0_we <= (~interface16_bank_bus_we);
	end
end
assign csrbank16_load0_w = timer_load_storage[31:0];
assign csrbank16_reload0_w = timer_reload_storage[31:0];
assign csrbank16_en0_w = timer_en_storage;
assign csrbank16_update_value0_w = timer_update_value_storage;
assign csrbank16_value_w = timer_value_status[31:0];
assign timer_value_we = csrbank16_value_we;
assign timer_status_status = timer_zero0;
assign csrbank16_ev_status_w = timer_status_status;
assign timer_status_we = csrbank16_ev_status_we;
assign timer_pending_status = timer_zero1;
assign csrbank16_ev_pending_w = timer_pending_status;
assign timer_pending_we = csrbank16_ev_pending_we;
assign timer_zero2 = timer_enable_storage;
assign csrbank16_ev_enable0_w = timer_enable_storage;
assign csrbank17_sel = (interface17_bank_bus_adr[13:9] == 5'd17);
assign uart_rxtx_r = interface17_bank_bus_dat_w[7:0];
always @(*) begin
	uart_rxtx_we <= 1'd0;
	uart_rxtx_re <= 1'd0;
	if ((csrbank17_sel & (interface17_bank_bus_adr[8:0] == 1'd0))) begin
		uart_rxtx_re <= interface17_bank_bus_we;
		uart_rxtx_we <= (~interface17_bank_bus_we);
	end
end
assign csrbank17_txfull_r = interface17_bank_bus_dat_w[0];
always @(*) begin
	csrbank17_txfull_re <= 1'd0;
	csrbank17_txfull_we <= 1'd0;
	if ((csrbank17_sel & (interface17_bank_bus_adr[8:0] == 1'd1))) begin
		csrbank17_txfull_re <= interface17_bank_bus_we;
		csrbank17_txfull_we <= (~interface17_bank_bus_we);
	end
end
assign csrbank17_rxempty_r = interface17_bank_bus_dat_w[0];
always @(*) begin
	csrbank17_rxempty_re <= 1'd0;
	csrbank17_rxempty_we <= 1'd0;
	if ((csrbank17_sel & (interface17_bank_bus_adr[8:0] == 2'd2))) begin
		csrbank17_rxempty_re <= interface17_bank_bus_we;
		csrbank17_rxempty_we <= (~interface17_bank_bus_we);
	end
end
assign csrbank17_ev_status_r = interface17_bank_bus_dat_w[1:0];
always @(*) begin
...
assign csrbank17_ev_pending_r = interface17_bank_bus_dat_w[1:0];
always @(*) begin
...
assign csrbank17_ev_enable0_r = interface17_bank_bus_dat_w[1:0];
always @(*) begin
...
assign csrbank17_txempty_r = interface17_bank_bus_dat_w[0];
always @(*) begin
	csrbank17_txempty_we <= 1'd0;
	csrbank17_txempty_re <= 1'd0;
	if ((csrbank17_sel & (interface17_bank_bus_adr[8:0] == 3'd6))) begin
		csrbank17_txempty_re <= interface17_bank_bus_we;
		csrbank17_txempty_we <= (~interface17_bank_bus_we);
	end
end
assign csrbank17_rxfull_r = interface17_bank_bus_dat_w[0];
always @(*) begin
	csrbank17_rxfull_we <= 1'd0;
	csrbank17_rxfull_re <= 1'd0;
	if ((csrbank17_sel & (interface17_bank_bus_adr[8:0] == 3'd7))) begin
		csrbank17_rxfull_re <= interface17_bank_bus_we;
		csrbank17_rxfull_we <= (~interface17_bank_bus_we);
	end
end
assign csrbank17_txfull_w = uart_txfull_status;
assign uart_txfull_we = csrbank17_txfull_we;
assign csrbank17_rxempty_w = uart_rxempty_status;
assign uart_rxempty_we = csrbank17_rxempty_we;
always @(*) begin
	uart_status_status <= 2'd0;
	uart_status_status[0] <= uart_tx0;
	uart_status_status[1] <= uart_rx0;
end
assign csrbank17_ev_status_w = uart_status_status[1:0];
assign uart_status_we = csrbank17_ev_status_we;
always @(*) begin
	uart_pending_status <= 2'd0;
	uart_pending_status[0] <= uart_tx1;
	uart_pending_status[1] <= uart_rx1;
end
assign csrbank17_ev_pending_w = uart_pending_status[1:0];
assign uart_pending_we = csrbank17_ev_pending_we;
assign uart_tx2 = uart_enable_storage[0];
assign uart_rx2 = uart_enable_storage[1];
assign csrbank17_ev_enable0_w = uart_enable_storage[1:0];
assign csrbank17_txempty_w = uart_txempty_status;
assign uart_txempty_we = csrbank17_txempty_we;
assign csrbank17_rxfull_w = uart_rxfull_status;
assign uart_rxfull_we = csrbank17_rxfull_we;
...
assign LIR_status = xilinxmultiregimpl3_regs1;
assign xilinxmultiregimpl3 = {LIR0};
assign RIR_status = xilinxmultiregimpl4_regs1;
assign xilinxmultiregimpl4 = {RIR0};
assign RGB_sensor_Out_status = xilinxmultiregimpl5_regs1;
assign xilinxmultiregimpl5 = {RGB_sensor_Out0};
assign ESP8266_status = xilinxmultiregimpl6_regs1;
assign xilinxmultiregimpl6 = {ESP82665, ESP82664, ESP82663, ESP82662, ESP82661, ESP82660};
...
always @(posedge sys_clk) begin
	...
	if (csrbank2_out0_re) begin
		RGB_sensor_EN_storage <= csrbank2_out0_r;
	end
	RGB_sensor_EN_re <= csrbank2_out0_re;
	...
	RGB_sensor_Out_re <= csrbank3_in_re;
	...
	if (csrbank4_out0_re) begin
		RGB_sensor_S_storage[3:0] <= csrbank4_out0_r;
	end
	RGB_sensor_S_re <= csrbank4_out0_re;
	...
	if (csrbank8_sel) begin
		case (interface8_bank_bus_adr[8:0])
			1'd0: begin
				interface8_bank_bus_dat_r <= csrbank8_r_enable0_w;
			end
			1'd1: begin
				interface8_bank_bus_dat_r <= csrbank8_r_width0_w;
			end
			2'd2: begin
				interface8_bank_bus_dat_r <= csrbank8_r_period0_w;
			end
			2'd3: begin
				interface8_bank_bus_dat_r <= csrbank8_g_enable0_w;
			end
			3'd4: begin
				interface8_bank_bus_dat_r <= csrbank8_g_width0_w;
			end
			3'd5: begin
				interface8_bank_bus_dat_r <= csrbank8_g_period0_w;
			end
			3'd6: begin
				interface8_bank_bus_dat_r <= csrbank8_b_enable0_w;
			end
			3'd7: begin
				interface8_bank_bus_dat_r <= csrbank8_b_width0_w;
			end
			4'd8: begin
				interface8_bank_bus_dat_r <= csrbank8_b_period0_w;
			end
		endcase
	end
	if (csrbank8_r_enable0_re) begin
		r_enable_storage <= csrbank8_r_enable0_r;
	end
	r_enable_re <= csrbank8_r_enable0_re;
	if (csrbank8_r_width0_re) begin
		r_width_storage[31:0] <= csrbank8_r_width0_r;
	end
	r_width_re <= csrbank8_r_width0_re;
	if (csrbank8_r_period0_re) begin
		r_period_storage[31:0] <= csrbank8_r_period0_r;
	end
	r_period_re <= csrbank8_r_period0_re;
	if (csrbank8_g_enable0_re) begin
		g_enable_storage <= csrbank8_g_enable0_r;
	end
	g_enable_re <= csrbank8_g_enable0_re;
	if (csrbank8_g_width0_re) begin
		g_width_storage[31:0] <= csrbank8_g_width0_r;
	end
	g_width_re <= csrbank8_g_width0_re;
	if (csrbank8_g_period0_re) begin
		g_period_storage[31:0] <= csrbank8_g_period0_r;
	end
	g_period_re <= csrbank8_g_period0_re;
	if (csrbank8_b_enable0_re) begin
		b_enable_storage <= csrbank8_b_enable0_r;
	end
	b_enable_re <= csrbank8_b_enable0_re;
	if (csrbank8_b_width0_re) begin
		b_width_storage[31:0] <= csrbank8_b_width0_r;
	end
	b_width_re <= csrbank8_b_width0_re;
	if (csrbank8_b_period0_re) begin
		b_period_storage[31:0] <= csrbank8_b_period0_r;
	end
	b_period_re <= csrbank8_b_period0_re;
	...
	if (csrbank9_out0_re) begin
		leds_storage[3:0] <= csrbank9_out0_r;
	end
	leds_re <= csrbank9_out0_re;
	interface10_bank_bus_dat_r <= 1'd0;
	if (csrbank10_sel) begin
		case (interface10_bank_bus_adr[8:0])
			1'd0: begin
				interface10_bank_bus_dat_r <= csrbank10_out0_w;
			end
		endcase
	end
	if (csrbank10_out0_re) begin
		motorEN1_storage <= csrbank10_out0_r;
	end
	motorEN1_re <= csrbank10_out0_re;
	...
	if (csrbank11_out0_re) begin
		motorEN2_storage <= csrbank11_out0_r;
	end
	motorEN2_re <= csrbank11_out0_re;
	...
	if (csrbank12_out0_re) begin
		motorEN3_storage <= csrbank12_out0_r;
	end
	motorEN3_re <= csrbank12_out0_re;
	interface13_bank_bus_dat_r <= 1'd0;
	if (csrbank13_sel) begin
		case (interface13_bank_bus_adr[8:0])
			1'd0: begin
				interface13_bank_bus_dat_r <= csrbank13_out0_w;
			end
		endcase
	end
	if (csrbank13_out0_re) begin
		motorEN4_storage <= csrbank13_out0_r;
	end
	motorEN4_re <= csrbank13_out0_re;
	interface14_bank_bus_dat_r <= 1'd0;
	if (csrbank14_sel) begin
		case (interface14_bank_bus_adr[8:0])
			1'd0: begin
				interface14_bank_bus_dat_r <= csrbank14_out0_w;
			end
		endcase
	end
	if (csrbank14_out0_re) begin
		stepper_storage[3:0] <= csrbank14_out0_r;
	end
	stepper_re <= csrbank14_out0_re;
	...
	switchs_re <= csrbank15_in_re;
	interface16_bank_bus_dat_r <= 1'd0;
	if (csrbank16_sel) begin
		case (interface16_bank_bus_adr[8:0])
			1'd0: begin
				interface16_bank_bus_dat_r <= csrbank16_load0_w;
			end
			1'd1: begin
				interface16_bank_bus_dat_r <= csrbank16_reload0_w;
			end
			2'd2: begin
				interface16_bank_bus_dat_r <= csrbank16_en0_w;
			end
			2'd3: begin
				interface16_bank_bus_dat_r <= csrbank16_update_value0_w;
			end
			3'd4: begin
				interface16_bank_bus_dat_r <= csrbank16_value_w;
			end
			3'd5: begin
	...
	if (csrbank16_load0_re) begin
		timer_load_storage[31:0] <= csrbank16_load0_r;
	end
	timer_load_re <= csrbank16_load0_re;
	if (csrbank16_reload0_re) begin
		timer_reload_storage[31:0] <= csrbank16_reload0_r;
	end
	timer_reload_re <= csrbank16_reload0_re;
	if (csrbank16_en0_re) begin
		timer_en_storage <= csrbank16_en0_r;
	end
	timer_en_re <= csrbank16_en0_re;
	if (csrbank16_update_value0_re) begin
		timer_update_value_storage <= csrbank16_update_value0_r;
	end
	timer_update_value_re <= csrbank16_update_value0_re;
	timer_value_re <= csrbank16_value_re;
	timer_status_re <= csrbank16_ev_status_re;
	if (csrbank16_ev_pending_re) begin
		timer_pending_r <= csrbank16_ev_pending_r;
	end
	timer_pending_re <= csrbank16_ev_pending_re;
	if (csrbank16_ev_enable0_re) begin
		timer_enable_storage <= csrbank16_ev_enable0_r;
	end
	timer_enable_re <= csrbank16_ev_enable0_re;
	interface17_bank_bus_dat_r <= 1'd0;
	if (csrbank17_sel) begin
		case (interface17_bank_bus_adr[8:0])
			1'd0: begin
				interface17_bank_bus_dat_r <= uart_rxtx_w;
			end
			1'd1: begin
				interface17_bank_bus_dat_r <= csrbank17_txfull_w;
			end
			2'd2: begin
				interface17_bank_bus_dat_r <= csrbank17_rxempty_w;
			end
			2'd3: begin
			...
			3'd6: begin
				interface17_bank_bus_dat_r <= csrbank17_txempty_w;
			end
			3'd7: begin
				interface17_bank_bus_dat_r <= csrbank17_rxfull_w;
			end
		endcase
	end
	uart_txfull_re <= csrbank17_txfull_re;
	uart_rxempty_re <= csrbank17_rxempty_re;
	uart_status_re <= csrbank17_ev_status_re;
	if (csrbank17_ev_pending_re) begin
		uart_pending_r[1:0] <= csrbank17_ev_pending_r;
	end
	uart_pending_re <= csrbank17_ev_pending_re;
	if (csrbank17_ev_enable0_re) begin
		uart_enable_storage[1:0] <= csrbank17_ev_enable0_r;
	end
	uart_enable_re <= csrbank17_ev_enable0_re;
	uart_txempty_re <= csrbank17_txempty_re;
	uart_rxfull_re <= csrbank17_rxfull_re;
	if (sys_rst) begin
		reset_storage <= 2'd0;
		reset_re <= 1'd0;
		...
		LIR_re <= 1'd0;
		RIR_re <= 1'd0;
		RGB_sensor_S_storage <= 4'd0;
		RGB_sensor_S_re <= 1'd0;
		RGB_sensor_EN_storage <= 1'd0;
		RGB_sensor_EN_re <= 1'd0;
		RGB_sensor_Out_re <= 1'd0;
		motorEN1_storage <= 1'd0;
		motorEN1_re <= 1'd0;
		motorEN2_storage <= 1'd0;
		motorEN2_re <= 1'd0;
		motorEN3_storage <= 1'd0;
		motorEN3_re <= 1'd0;
		motorEN4_storage <= 1'd0;
		motorEN4_re <= 1'd0;
		stepper_storage <= 4'd0;
		stepper_re <= 1'd0;
		ESP8266_re <= 1'd0;
		grant <= 1'd0;
		slave_sel_r <= 4'd0;
	...
	xilinxmultiregimpl3_regs0 <= {LIR0};
	xilinxmultiregimpl3_regs1 <= xilinxmultiregimpl3_regs0;
	xilinxmultiregimpl4_regs0 <= {RIR0};
	xilinxmultiregimpl4_regs1 <= xilinxmultiregimpl4_regs0;
	xilinxmultiregimpl5_regs0 <= {RGB_sensor_Out0};
	xilinxmultiregimpl5_regs1 <= xilinxmultiregimpl5_regs0;
	xilinxmultiregimpl6_regs0 <= {ESP82665, ESP82664, ESP82663, ESP82662, ESP82661, ESP82660};
...
//------------------------------------------------------------------------------
// Memory rom: 5824-words x 32-bit
//------------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2022-11-24 02:28:23.
//------------------------------------------------------------------------------
